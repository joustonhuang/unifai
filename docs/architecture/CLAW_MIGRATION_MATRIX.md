...
| --- | --- | --- |
| Plugin manifest model with explicit tool schema, lifecycle, and hook declarations | Govern every third-party hook/plugin through explicit permissions, audit, and Supervisor-owned enforcement boundaries | Never execute third-party hooks directly in the Supervisor process context |
