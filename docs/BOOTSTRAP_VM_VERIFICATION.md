...
- the local hardening stack is currently ahead of that public ref through `221a36f` (`scripts: report live branch state in checkpoint handoff`), 35 commits ahead in total
...
- the latest non-doc logic delta in that local stack is `221a36f` (`scripts: report live branch state in checkpoint handoff`) in:
