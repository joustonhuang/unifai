...
- the local hardening stack is currently ahead of that public ref through `03d08af` (`tests: cover missing vm report on verifier failure`), 31 commits ahead in total
