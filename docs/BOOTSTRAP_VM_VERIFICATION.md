...
- the local hardening stack is currently ahead of that public ref through `9f7046a` (`tests: cover installer failure smoke in preflight`), 37 commits ahead in total
