...
- the local hardening stack is currently ahead of that public ref through `f497f07` (`scripts: detect stale verifier checkpoint handoff`), 37 commits ahead in total
...
- the latest non-doc logic delta in that local stack is `f497f07` (`scripts: detect stale verifier checkpoint handoff`) in:
