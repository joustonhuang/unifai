...
- the local hardening stack is currently ahead of that public ref through `0a42ae1` (`tests: pin checkpoint refresh tip handoff`), 90 commits ahead in total
...
- the latest non-doc logic delta in that local stack is `0a42ae1` (`tests: pin checkpoint refresh tip handoff`) in:
