...
- the local hardening stack is currently ahead of that public ref through `376062b` (`tests: cover vm verifier remote failure excerpts`), 29 commits ahead in total
