...
smoke_required = [
    ...
    ('git add ci-artifacts/publish-stack-reconciliation-next-step.txt', "Publish stack parity smoke test checks the inferred-handoff path while the checked-in publish-stack reconciliation note differs"),
