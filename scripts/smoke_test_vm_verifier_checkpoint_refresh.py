...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="unifai-vm-checkpoint-") as tmp:
        ...
        assert "  - `python3 scripts/check_publish_stack_reconciliation_note.py`\n" in checkpoint
        assert "  - `python3 scripts/check_publish_stack_reconciliation_note_contract.py`\n" in checkpoint
        assert "  - `python3 scripts/check_compare_publish_branch_histories_contract.py`\n" in checkpoint
        assert "  - `python3 scripts/check_branch_reconcile_handoff.py`\n" in checkpoint
        assert "  - `python3 scripts/check_branch_reconcile_handoff_contract.py`\n" in checkpoint
        ...
        assert "  - `bash scripts/smoke_test_publish_stack_reconciliation_note.sh`\n" in checkpoint
        assert "  - `bash scripts/smoke_test_branch_reconcile_handoff.sh`\n" in checkpoint
