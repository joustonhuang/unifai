...
required = [
    ...
    ('require_file "$REPO_ROOT/scripts/check_gaia_workflow_contract.py"', 'Preflight requires the Gaia workflow contract checker'),
    ('require_file "$REPO_ROOT/scripts/check_gaia_workflow_contract_contract.py"', 'Preflight requires the Gaia workflow contract checker contract'),
    ...
    ('require_file "$REPO_ROOT/scripts/check_publish_stack_reconciliation_note.py"', 'Preflight requires the publish-stack reconciliation note freshness checker'),
    ('require_file "$REPO_ROOT/scripts/check_publish_stack_reconciliation_note_contract.py"', 'Preflight requires the publish-stack reconciliation note contract checker'),
    ...
    ('require_file "$REPO_ROOT/scripts/smoke_test_publish_stack_reconciliation_note.sh"', 'Preflight requires the publish-stack reconciliation note smoke test'),
    ...
    ('require_file "$REPO_ROOT/scripts/smoke_test_github_branch_visibility_forced_remote.sh"', 'Preflight requires the GitHub branch-visibility forced-remote smoke test'),
    ...
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_gaia_workflow_contract.py"', 'Preflight syntax-checks the Gaia workflow contract checker'),
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_gaia_workflow_contract_contract.py"', 'Preflight syntax-checks the Gaia workflow contract checker contract'),
    ...
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_publish_stack_reconciliation_note.py"', 'Preflight syntax-checks the publish-stack reconciliation note freshness checker'),
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_publish_stack_reconciliation_note_contract.py"', 'Preflight syntax-checks the publish-stack reconciliation note contract checker'),
    ...
    ('bash -n "$REPO_ROOT/scripts/smoke_test_publish_stack_reconciliation_note.sh"', 'Preflight syntax-checks the publish-stack reconciliation note smoke test'),
    ...
    ('bash -n "$REPO_ROOT/scripts/smoke_test_github_branch_visibility_forced_remote.sh"', 'Preflight syntax-checks the GitHub branch-visibility forced-remote smoke script'),
    ...
    ('python3 "$REPO_ROOT/scripts/check_gaia_workflow_contract.py"', 'Preflight runs the Gaia workflow contract checker'),
    ('python3 "$REPO_ROOT/scripts/check_gaia_workflow_contract_contract.py"', 'Preflight runs the Gaia workflow contract checker contract'),
    ...
    ('python3 "$REPO_ROOT/scripts/check_publish_stack_reconciliation_note.py"', 'Preflight runs the publish-stack reconciliation note freshness checker'),
    ('python3 "$REPO_ROOT/scripts/check_publish_stack_reconciliation_note_contract.py"', 'Preflight runs the publish-stack reconciliation note contract checker'),
    ...
    ('bash "$REPO_ROOT/scripts/smoke_test_github_branch_visibility_forced_remote.sh"', 'Preflight runs the GitHub branch-visibility forced-remote smoke test'),
    ...
    ('bash "$REPO_ROOT/scripts/smoke_test_publish_stack_reconciliation_note.sh"', 'Preflight runs the publish-stack reconciliation note smoke test'),
