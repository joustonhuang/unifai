...
required = [
    ...
    ('require_file "$REPO_ROOT/scripts/check_vm_verifier_checkpoint_freshness_contract.py"', 'Preflight requires the VM verifier checkpoint freshness contract checker'),
    ...
    ('require_file "$REPO_ROOT/scripts/check_branch_reconcile_handoff.py"', 'Preflight requires the branch-reconcile handoff checker'),
    ('require_file "$REPO_ROOT/scripts/check_branch_reconcile_handoff_contract.py"', 'Preflight requires the branch-reconcile handoff contract checker'),
    ('require_file "$REPO_ROOT/scripts/smoke_test_branch_reconcile_handoff.sh"', 'Preflight requires the branch-reconcile handoff smoke test'),
    ...
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_github_branch_visibility_contract.py"', 'Preflight syntax-checks the GitHub branch-visibility contract checker'),
    ...
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_vm_verifier_checkpoint_freshness.py"', 'Preflight syntax-checks the VM verifier checkpoint freshness checker'),
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_vm_verifier_checkpoint_freshness_contract.py"', 'Preflight syntax-checks the VM verifier checkpoint freshness contract checker'),
    ...
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_branch_reconcile_handoff.py"', 'Preflight syntax-checks the branch-reconcile handoff checker'),
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_branch_reconcile_handoff_contract.py"', 'Preflight syntax-checks the branch-reconcile handoff contract checker'),
    ('bash -n "$REPO_ROOT/scripts/smoke_test_branch_reconcile_handoff.sh"', 'Preflight syntax-checks the branch-reconcile handoff smoke test'),
    ...
    ('bash -n "$REPO_ROOT/scripts/smoke_test_github_branch_visibility_no_github_remote.sh"', 'Preflight syntax-checks the GitHub branch-visibility no-GitHub-remote smoke script'),
    ...
    ('python3 "$REPO_ROOT/scripts/check_github_branch_visibility_contract.py"', 'Preflight runs the GitHub branch-visibility contract checker'),
    ...
    ('bash "$REPO_ROOT/scripts/smoke_test_branch_reconcile_handoff.sh"', 'Preflight runs the branch-reconcile handoff smoke test'),
    ('python3 "$REPO_ROOT/scripts/smoke_test_github_check_gate.py"', 'Preflight runs the GitHub check-gate smoke test'),
    ('python3 -B "$REPO_ROOT/scripts/smoke_test_vm_verifier_checkpoint_freshness.py"', 'Preflight runs the VM verifier checkpoint freshness smoke test'),
