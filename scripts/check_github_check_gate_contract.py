...
required = [
    ...
    ('def local_branch_candidate(ref: str) -> str | None:', 'GitHub check-gate inspector can normalize explicit refs/heads local branch refs to branch names'),
    ...
    ('for candidate in [ref, local_branch_candidate(ref), github_remote_branch_candidate(ref)]:', 'GitHub check-gate inspector prefers refs/heads normalization before remote-tracking fallback'),
