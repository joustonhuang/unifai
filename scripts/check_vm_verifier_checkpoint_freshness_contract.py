...
required = [
    ...
    ('boundary_dirty_line, checkpoint_dirty_line = dirty_bundle_lines(dirty_paths)', "Freshness checker computes live dirty-bundle summary lines"),
    ...
    ('require_exact_line(boundary_text, boundary_dirty_line, "Boundary doc dirty bundle summary")', "Freshness checker validates the boundary doc dirty-bundle summary as an exact line"),
...
smoke_required = [
    ...
    ('assert "Boundary doc dirty bundle summary is stale; expected exact line:" in stale_dirty_boundary_output', "Freshness smoke test fails closed when the boundary doc dirty-bundle summary drifts"),
    ('assert "Boundary doc dirty bundle summary is stale; expected exact line:" in stale_dirty_boundary_suffix_output', "Freshness smoke test fails closed when the boundary doc keeps stale trailing dirty-bundle wording"),
