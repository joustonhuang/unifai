...
required = [
    ...
    ('"Boundary doc dirty bundle summary"', "Freshness checker validates the boundary doc dirty-bundle summary"),
...
smoke_required = [
    ...
    ('assert "Boundary doc dirty bundle summary is stale; expected to find:" in stale_dirty_boundary_output', "Freshness smoke test fails closed when the boundary doc dirty-bundle summary drifts"),
