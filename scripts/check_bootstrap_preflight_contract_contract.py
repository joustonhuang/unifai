...
required = [
    ...
    ('require_file "$REPO_ROOT/scripts/check_gaia_workflow_contract.py"', 'Bootstrap preflight contract checker requires the Gaia workflow contract checker'),
    ('require_file "$REPO_ROOT/scripts/check_gaia_workflow_contract_contract.py"', 'Bootstrap preflight contract checker requires the Gaia workflow contract checker contract'),
    ...
    ('require_file "$REPO_ROOT/scripts/smoke_test_github_branch_visibility_forced_remote.sh"', 'Bootstrap preflight contract checker requires the GitHub branch-visibility forced-remote smoke test path'),
    ...
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_gaia_workflow_contract.py"', 'Bootstrap preflight contract checker requires py_compile coverage for the Gaia workflow contract checker'),
    ('python3 -m py_compile "$REPO_ROOT/scripts/check_gaia_workflow_contract_contract.py"', 'Bootstrap preflight contract checker requires py_compile coverage for the Gaia workflow contract checker contract'),
    ...
    ('bash -n "$REPO_ROOT/scripts/smoke_test_github_branch_visibility_forced_remote.sh"', 'Bootstrap preflight contract checker requires syntax coverage for the branch-visibility forced-remote smoke test'),
    ...
    ('python3 "$REPO_ROOT/scripts/check_gaia_workflow_contract.py"', 'Bootstrap preflight contract checker requires runtime coverage for the Gaia workflow contract checker'),
    ('python3 "$REPO_ROOT/scripts/check_gaia_workflow_contract_contract.py"', 'Bootstrap preflight contract checker requires runtime coverage for the Gaia workflow contract checker contract'),
    ...
    ('bash "$REPO_ROOT/scripts/smoke_test_github_branch_visibility_forced_remote.sh"', 'Bootstrap preflight contract checker requires the branch-visibility forced-remote smoke test'),
